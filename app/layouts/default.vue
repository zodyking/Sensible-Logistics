...
const tabs = [
  ...
  { to: '/containers', label: 'Containers', icon: '▦', match: (p: string) => p.startsWith('/containers') },
  { to: '/more', label: 'More', icon: '≡', match: (p: string) => p.startsWith('/more') || p.startsWith('/scan') || p.startsWith('/locations') },
]
</script>
